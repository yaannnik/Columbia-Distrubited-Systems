...
// KeyValue Map and Reduce deal with <key, value> pairs:
...
// MapName Name of the file that is the input for map job <MapJob>
...
// DoReduce Read map outputs for partition job, sort them by key, call reduce for each
// key
