...
// DoJob The master sent us a job
...
// Shutdown The master is telling us to shutdown. Report the number of Jobs we
// have processed.
...
// Register Tell the master we exist and ready to work
...
// RunWorker Set up a connection with the master, register with the master,
